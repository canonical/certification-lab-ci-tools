...
def get_args():
    ...
    parser.add_argument(
        "--attach", "-a", required=False, action="append", help="Attach a file"
    )
    parser.add_argument("messagefile", help="File containing the message to send")
...
def main():
    ...
    send_mail(to=args.to, subject=args.subject, body=body, attachments=args.attach)
